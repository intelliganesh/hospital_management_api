...
class IPDDischargeSummaryController extends Controller
{
     ...
     *             @OA\Property(property="summary_type", type="string", enum={"surgical", "non_surgical"}, example="non_surgical"),
     ...
     *             @OA\Property(property="menstrual_history", type="string", example="Normal"),
     ...
     *             @OA\Property(property="summary_of_treatment", type="string", example="Sarvanga abhyanga with Mahanarayana taila"),
