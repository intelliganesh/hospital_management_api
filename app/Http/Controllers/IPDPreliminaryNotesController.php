...
class IPDPreliminaryNotesController extends Controller
{
     ...
     *             @OA\Property(property="examination_comments", type="string", description="Examination comments", example="Patient appears uncomfortable"),
     ...
     *             @OA\Property(property="examination_comments", type="string"),
