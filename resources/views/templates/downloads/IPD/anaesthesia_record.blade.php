...
<body>
    ...
    <table>
        <tr>
            <td width="70%"><b>Surgical Procedure:</b> {{ $ipd->surgery_report?->surgery_name ?? '' }}</td>
            <td width="30%"><b>Position:  {{ $ipd->anaesthesia?->position ?? '' }}</b></td>
        </tr>
    </table>
    <table>
        <tr>
            <td width="10%"><b>Anaesthetist:</b> </td>
            <td width="40%">{{ $ipd->surgery_report?->anaesthetist ?? '' }}</td>
            <td width="10%"><b>Surgeons:</b> </td>
            <td width="40%">{{ $ipd->surgery_report?->surgeon ?? '' }}</td>
        </tr>
    </table>
    <table>
        <tr>
            <td width="10%"><b>Assistants:</b> </td>
            <td width="40%">{{$ipd->anaesthesia?->anaesthetist_assistant ?? ''}}</td>
            <td width="10%"><b>Assistants:</b> </td>
            <td width="40%">{{ $ipd->surgery_report?->assistant ?? '' }}</td>
        </tr>
    </table>
