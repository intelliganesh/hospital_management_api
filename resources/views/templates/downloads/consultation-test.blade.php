    ...
    <div class="section">
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td colspan="5" style="font-family: 'Noto Sans Kannada', 'Arial', sans-serif;">
    ...
    <div class="section">
        ...
        <table class="info-table">
            <tr>
                ...
                <td class="label">Consultation Discount</td>
                <td>Rs {{ $discount_amount ? (float)$discount_amount : '-' }}</td>
            </tr>
            <tr>
