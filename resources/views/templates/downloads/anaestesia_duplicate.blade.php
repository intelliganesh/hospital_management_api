...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
            <tr class="row0">
                <td class="column0 style5 s style5" colspan="26">Name:</td>
                <td class="column26 style5 s style5" colspan="6">Age:</td>
                <td class="column32 style2 s style2" colspan="6">Sex: M/F</td>
            ...
            <tr class="row6">
                <td class="column1 style2 s style2" colspan="2">N<span
                        ...
                        style="font-weight:bold; color:#000000; font-family:'Arial'; font-size:8pt">O (L/Min)</span>
                </td>
                <td class="column3 style8 s"></td>
                <td class="column3 style8 s"></td>
                <td class="column3 style8 s"></td>
